    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const Text(
            'تحكم بظهور حسابك ووسائل التواصل معك.',
              ...
              [
                _tile(
                  ...
                  () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => NAdminPage(data: widget.data),
                    ),
                  ),
                ),
              ],
  ...
  Future<void> _signOutOtherSessions() async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: const Text(
          'سيتم تسجيل خروج حسابك من جميع الأجهزة الأخرى، '
          'وسيظل هذا الجهاز متصلًا.',
        ),
        actions: [
          TextButton(
